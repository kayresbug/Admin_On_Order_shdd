...
public class isPrinter {
    public Sam4sPrint setPrinter1(){
        ...
        try {
            Thread.sleep(300);
            sam4sPrint.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.0.130", 9100);
    ...
    public Sam4sPrint setPrinter2(){
        ...
        try {
            Thread.sleep(300);
            sam4sPrint.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.0.132", 9100);
            sam4sPrint.resetPrinter();
        } catch (Exception exception) {
            exception.printStackTrace();
        }
    ...
    public Sam4sPrint setPrinter3(){
        ...
        try {
            Thread.sleep(300);
            sam4sPrint.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.0.135", 9100);
            sam4sPrint.resetPrinter();
        } catch (Exception exception) {
            exception.printStackTrace();
        }
    ...
    public Sam4sPrint setPrinter4(){
        ...
        try {
            Thread.sleep(300);
            sam4sPrint.openPrinter(Sam4sPrint.DEVTYPE_ETHERNET, "192.168.0.137", 9100);
            sam4sPrint.resetPrinter();
        } catch (Exception exception) {
            exception.printStackTrace();
        }
